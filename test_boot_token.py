...
class BootTokenClient:
    ...
    def __init__(self, customer_id: str, application_id: str, device_serial: str,
                 device_type: str, version: str, git_hash: str,
    ...
    def setup_mqtt_client(self):
        ...
        try:
            self.mqtt_client = mqtt.Client(
                client_id=f"cust-{self.customer_id}-{random.randint(1000, 999999)}"
            )
    ...
    def _on_connect(self, client, userdata, flags, rc):
        ...
        if rc == 0:
            ...
            response_topic = f"boot/v0/{self.customer_id}/{self.application_id}/{self.device_serial}"
    ...
    def publish_boot_message(self, timestamp: int = None) -> bool:
        ...
        try:
            ...
            topic = f"boot/v0/{self.customer_id}/{self.application_id}"
